...
6. `manifest.yml` / task-scoped manifests are honor contracts (readable/writable lists), not OS sandboxes. On conflict with task instructions, stop and ask the user.
